...
autocmd Filetype markdown inoremap ,l --------<Enter>l
...
"snippet将tab换为ctrl-s避免与coc.nvim的按键冲突,下一输入点ctrl-b换为ctrl-j避免和tmux的冲突,上一个输入点换为ctrl-k
